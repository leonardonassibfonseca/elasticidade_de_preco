...
df_elasticidade = pd.read_csv('dataset/df_elasticidade.csv')
df_resultado_negocio = pd.read_csv('dataset/df_resultado_negocio.csv')
...
with col2:
    image = Image.open('img/imagem_elasticidade.jpg') #Imagem precisa estar na mesma pasta do arquivo .PY
